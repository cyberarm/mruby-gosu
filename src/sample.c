...
extern struct RClass* mrb_gosu_sample;
...
static void mrb_gosu_sample_data_free(mrb_state* mrb, void* ptr)
{
...
Gosu_Sample* mrb_gosu_sample_get_ptr(mrb_state* mrb, mrb_value self)
{
    mrb_gosu_sample_data_t* data = (mrb_gosu_sample_data_t*) DATA_PTR(self);
    return data->sample;
}

mrb_value mrb_gosu_sample_initialize(mrb_state* mrb, mrb_value self)
{
    mrb_value path;
...
static mrb_value mrb_gosu_sample_play(mrb_state* mrb, mrb_value self)
{
    mrb_float volume, speed;
    mrb_bool looping;

    mrb_get_args(mrb, "ffb", &volume, &speed, &looping);
    Gosu_Channel* pointer = Gosu_Sample_play(mrb_gosu_sample_get_ptr(mrb, self), volume, speed, looping);
...
static mrb_value mrb_gosu_sample_play_pan(mrb_state* mrb, mrb_value self)
{
    mrb_float pan, volume, speed;
    mrb_bool looping;

    mrb_get_args(mrb, "fffb", &pan, &volume, &speed, &looping);
    Gosu_Channel* pointer = Gosu_Sample_play_pan(mrb_gosu_sample_get_ptr(mrb, self), pan, volume, speed, looping);
