...
extern struct RClass* mrb_gosu_channel;
...
static void mrb_gosu_channel_data_free(mrb_state* mrb, void* ptr)
{
...
static Gosu_Channel* mrb_gosu_channel_get_ptr(mrb_state* mrb, mrb_value self)
{
    mrb_gosu_channel_data_t* data = (mrb_gosu_channel_data_t*) DATA_PTR(self);
    return data->channel;
}

static mrb_value mrb_gosu_channel_initialize(mrb_state* mrb, mrb_value self)
{
    mrb_value channel;
...
static mrb_value mrb_gosu_channel_set_pan(mrb_state* mrb, mrb_value self)
{
    mrb_float pan;
...
static mrb_value mrb_gosu_channel_set_speed(mrb_state* mrb, mrb_value self)
{
    mrb_float speed;
...
static mrb_value mrb_gosu_channel_set_volume(mrb_state* mrb, mrb_value self)
{
    mrb_float volume;
...
static mrb_value mrb_gosu_channel_pause(mrb_state* mrb, mrb_value self)
{
...
static mrb_value mrb_gosu_channel_is_paused(mrb_state* mrb, mrb_value self)
{
    return mrb_bool_value(Gosu_Channel_paused(mrb_gosu_channel_get_ptr(mrb, self)));
}

static mrb_value mrb_gosu_channel_is_playing(mrb_state* mrb, mrb_value self)
{
    return mrb_bool_value(Gosu_Channel_playing(mrb_gosu_channel_get_ptr(mrb, self)));
}

static mrb_value mrb_gosu_channel_resume(mrb_state* mrb, mrb_value self)
{
...
static mrb_value mrb_gosu_channel_stop(mrb_state* mrb, mrb_value self)
{
