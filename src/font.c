...
extern struct RClass* mrb_gosu_font;
...
static void mrb_gosu_font_data_free(mrb_state* mrb, void* ptr)
{
...
Gosu_Font* mrb_gosu_font_get_ptr(mrb_state* mrb, mrb_value self)
{
...
mrb_value mrb_gosu_font_name(mrb_state* mrb, mrb_value self)
{
...
mrb_value mrb_gosu_font_markup_width(mrb_state* mrb, mrb_value self)
{
    mrb_value string;
    mrb_get_args(mrb, "S", &string);
...
mrb_value mrb_gosu_font_draw_text(mrb_state* mrb, mrb_value self)
{
    mrb_value string;
...
mrb_value mrb_gosu_font_draw_markup(mrb_state* mrb, mrb_value self)
{
    mrb_value string;
    mrb_float x, y, z, scale_x, scale_y;
    mrb_int color, mode;
...
mrb_value mrb_gosu_font_draw_text_rel(mrb_state* mrb, mrb_value self)
{
    mrb_value string;
    ...
    Gosu_Font_draw_text_rel(mrb_gosu_font_get_ptr(mrb, self), mrb_string_cstr(mrb, string), x, y, z, rel_x, rel_y, scale_x, scale_y, color,
                            mode);

    return self;
}

mrb_value mrb_gosu_font_draw_markup_rel(mrb_state* mrb, mrb_value self)
{
    mrb_value string;
    mrb_float x, y, z, rel_x, rel_y, scale_x, scale_y;
    mrb_int color, mode;
    ...
    Gosu_Font_draw_markup_rel(mrb_gosu_font_get_ptr(mrb, self), mrb_string_cstr(mrb, string), x, y, z, rel_x, rel_y, scale_x, scale_y,
                              color, mode);

    return self;
}

mrb_value mrb_gosu_font_set_image(mrb_state* mrb, mrb_value self)
{
