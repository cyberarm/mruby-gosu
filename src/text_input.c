...
static void mrb_gosu_text_input_data_free(mrb_state* mrb, void* ptr)
{
...
static mrb_value mrb_gosu_text_input_initialize(mrb_state* mrb, mrb_value self)
{
...
static mrb_value mrb_gosu_text_input_text(mrb_state* mrb, mrb_value self)
{
    return mrb_str_new_cstr(mrb, Gosu_TextInput_text(mrb_gosu_text_input_get_ptr(mrb, self)));
}

static mrb_value mrb_gosu_text_input_set_text(mrb_state* mrb, mrb_value self)
{
    mrb_value text;
...
static mrb_value mrb_gosu_text_input_caret_pos(mrb_state* mrb, mrb_value self)
{
    return mrb_fixnum_value(Gosu_TextInput_caret_pos(mrb_gosu_text_input_get_ptr(mrb, self)));
}

static mrb_value mrb_gosu_text_input_set_caret_pos(mrb_state* mrb, mrb_value self)
{
    mrb_int position;
...
static mrb_value mrb_gosu_text_input_selection_start(mrb_state* mrb, mrb_value self)
{
    return mrb_fixnum_value(Gosu_TextInput_selection_start(mrb_gosu_text_input_get_ptr(mrb, self)));
}

static mrb_value mrb_gosu_text_input_set_selection_start(mrb_state* mrb, mrb_value self)
{
    mrb_int position;
    mrb_get_args(mrb, "i", &position);
...
static mrb_value mrb_gosu_text_input_delete_backward(mrb_state* mrb, mrb_value self)
{
...
static mrb_value mrb_gosu_text_input_delete_forward(mrb_state* mrb, mrb_value self)
{
