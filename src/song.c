...
extern struct RClass* mrb_gosu_song;
...
static void mrb_gosu_song_data_free(mrb_state* mrb, void* ptr)
{
...
Gosu_Song* mrb_gosu_song_get_ptr(mrb_state* mrb, mrb_value self)
{
    mrb_gosu_song_data_t* data = (mrb_gosu_song_data_t*) DATA_PTR(self);
    return data->song;
}

static mrb_value mrb_gosu_song_current_song(mrb_state* mrb, mrb_value self)
{
    Gosu_Song* song;
...
mrb_value mrb_gosu_song_initialize(mrb_state* mrb, mrb_value self)
{
    mrb_value path;
...
static mrb_value mrb_gosu_song_set_volume(mrb_state* mrb, mrb_value self)
{
    mrb_float volume;
...
static mrb_value mrb_gosu_song_play(mrb_state* mrb, mrb_value self)
{
    mrb_bool looping;
...
static mrb_value mrb_gosu_song_pause(mrb_state* mrb, mrb_value self)
{
...
static mrb_value mrb_gosu_song_is_paused(mrb_state* mrb, mrb_value self)
{
    return mrb_bool_value(Gosu_Song_paused(mrb_gosu_song_get_ptr(mrb, self)));
}

static mrb_value mrb_gosu_song_is_playing(mrb_state* mrb, mrb_value self)
{
    return mrb_bool_value(Gosu_Song_playing(mrb_gosu_song_get_ptr(mrb, self)));
}

static mrb_value mrb_gosu_song_stop(mrb_state* mrb, mrb_value self)
{
