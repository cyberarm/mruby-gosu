...
module TestHelper
  def self.media_path(fname = "")
    File.join(File.expand_path("..", __FILE__), "media", fname)
  end
...
Dir.entries("#{File.dirname(__FILE__)}").each do |file|
  if file.end_with?(".rb") && file.start_with?("test_")
    next if file.match(/interface|helper/)
    test_files << "#{File.expand_path("..", __FILE__)}/#{file}"
    # require "#{File.expand_path("..", __FILE__)}/#{file}"
  end
end

loading = [
  "/home/cyberarm/Code/mruby-gosu/test/test_font.rb",
  "/home/cyberarm/Code/mruby-gosu/test/test_text.rb",
  "/home/cyberarm/Code/mruby-gosu/test/test_gosu_module.rb",
  "/home/cyberarm/Code/mruby-gosu/test/test_color.rb",
  "/home/cyberarm/Code/mruby-gosu/test/test_image_io.rb",
  "/home/cyberarm/Code/mruby-gosu/test/test_audio.rb",
  "/home/cyberarm/Code/mruby-gosu/test/test_image.rb",
  "/home/cyberarm/Code/mruby-gosu/test/test_window.rb",
  "/home/cyberarm/Code/mruby-gosu/test/test_constants.rb",
]

loading.each do |test|
  require test
end
